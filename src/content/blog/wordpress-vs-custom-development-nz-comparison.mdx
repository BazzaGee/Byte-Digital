...
Here is a realistic cost comparison for a typical New Zealand business website:

### WordPress

- **Initial build**: $3,000-$15,000 depending on customisation level
- **Theme**: $0-$200 for a premium theme, or $2,000-$10,000 for a custom theme
- **Plugins**: $0-$500/year for premium plugins
- **Hosting**: $20-$100/month for managed WordPress hosting
- **Maintenance**: $100-$500/month for ongoing updates, security, and support
- **Total 3-year cost**: Approximately $10,000-$30,000+

### Custom Development

- **Initial build**: $8,000-$30,000+ depending on complexity
- **Hosting**: $20-$80/month (modern hosting is often cheaper since sites are lighter)
- **Maintenance**: $50-$300/month (fewer updates needed, no plugin management)
- **Total 3-year cost**: Approximately $12,000-$40,000+

While custom development often has a higher upfront cost, the total cost of ownership over three years can be comparable or even lower, especially when factoring in the performance and security benefits.
