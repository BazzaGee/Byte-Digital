---
title: "CookTwo — Collaborative Adaptive Nutrition PWA for Couples"
client: "CookTwo"
industry: "Mobile App / HealthTech"
description: "Byte Digital designed, engineered, and launched CookTwo — a real-time, AI-powered progressive web app that lets couples with different dietary goals cook one meal together, plated two ways. A full-stack case study in real-time sync, multi-provider AI, and edge architecture."
pubDate: 2026-07-01
